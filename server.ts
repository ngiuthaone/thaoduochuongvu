...
const defaultAboutUs = {
  ...
  paragraph1: "Thảo Dược Hương Vũ bắt đầu từ niềm yêu quý những sản vật tự nhiên của vùng núi Bắc Hà, Lào Cai và kinh nghiệm tìm hiểu, lựa chọn các loại thảo dược được người dân địa phương sử dụng qua nhiều thế hệ.",
  paragraph2: "Chúng tôi tập trung vào những sản phẩm thảo dược có nguồn gốc rõ ràng, được lựa chọn kỹ từ khâu nguyên liệu, làm sạch đến sơ chế và bảo quản. Với nhiều sản phẩm, Hương Vũ vẫn ưu tiên phương pháp chế biến thủ công nhằm giữ được đặc tính tự nhiên, màu sắc và hương thơm vốn có của nguyên liệu.",
  paragraph3: "Không chạy theo những lời quảng cáo phóng đại, Hương Vũ mong muốn khách hàng nhớ đến mình bằng sự chân thành, chất lượng ổn định và cách làm ăn lâu dài. Mỗi sản phẩm gửi đi đều là sự trân trọng dành cho thảo dược quê hương Bắc Hà và cho sự tin tưởng của từng khách hàng.",
  statNumber: "15+ Năm",
...
const defaultContact = {
  ...
  bannerDesc: "Chuyên cung cấp sỉ lẻ thảo dược, nông sản Tây Bắc và đồ gỗ mỹ nghệ tuyển chọn. Sản phẩm được lựa chọn kỹ, ưu tiên nguồn gốc rõ ràng, chất lượng tốt và giá trị sử dụng lâu dài.",
