    ...
    <section id="about" className="py-16 bg-[#fbfbf9] border-t border-[#dfd4c0]/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl font-extrabold text-[#153020] tracking-tight whitespace-pre-line">
            {data.title || "VỀ CHÚNG TÔI - THẢO DƯỢC HƯƠNG VŨ"}
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          <div className="lg:col-span-5 relative">
            ...
            <div className="absolute -bottom-6 -right-6 md:right-4 bg-[#153020] text-white rounded-xl p-4.5 border border-[#dfd4c0]/40 shadow-xl max-w-[180px]">
